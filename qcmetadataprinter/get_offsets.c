...
int main() {
    ...
    PRINT(CAM_INTF_META_AF_DEFAULT_ROI, pMetadata);
    ...
    PRINT(CAM_INTF_META_AWB_CONVERGENCE_SPEED, pMetadata);
    ...
    PRINT(CAM_INTF_META_FOCUS_VALUE, pMetadata);
    PRINT(CAM_INTF_META_SPOT_LIGHT_DETECT, pMetadata);
    ...
    PRINT(CAM_INTF_META_ISP_SENSITIVITY, pMetadata);
    ...
    PRINT(CAM_INTF_PARM_SYNC_DC_PARAMETERS, pMetadata);
    PRINT(CAM_INTF_META_AF_FOCUS_POS, pMetadata);
    ...
    PRINT(CAM_INTF_PARM_USERZOOM, pMetadata);
    ...
    PRINT(CAM_INTF_PARM_VFE1_RESERVED_RDI, pMetadata);
    PRINT(CAM_INTF_PARM_SKIP_FINE_SCAN, pMetadata);

    /* HAL3 specific */
    PRINT(CAM_INTF_META_STREAM_INFO, pMetadata);
    PRINT(CAM_INTF_META_AEC_MODE, pMetadata);
    PRINT(CAM_INTF_META_AEC_CONVERGENCE_SPEED, pMetadata);
    ...
    PRINT(CAM_INTF_META_IR_MODE, pMetadata);
    ...
    PRINT(CAM_INTF_META_DC_LOW_POWER_ENABLE, pMetadata);
    PRINT(CAM_INTF_META_DC_SAC_OUTPUT_INFO, pMetadata);
    PRINT(CAM_INTF_META_DC_IN_SNAPSHOT_PP_ZOOM_RANGE, pMetadata);
    PRINT(CAM_INTF_META_DC_BOKEH_MODE, pMetadata);
    PRINT(CAM_INTF_PARM_FOV_COMP_ENABLE, pMetadata);
    PRINT(CAM_INTF_META_LED_CALIB_RESULT, pMetadata);
    //PRINT(CAM_INTF_PARM_DC_USERZOOM, pMetadata);
    PRINT(CAM_INTF_META_AEC_LUX_INDEX, pMetadata);
    PRINT(CAM_INTF_META_AF_OBJ_DIST_CM, pMetadata);
    PRINT(CAM_INTF_META_BINNING_CORRECTION_MODE, pMetadata);

    /* HAL1 and HAL3 Dual Camera */
    PRINT(CAM_INTF_META_OIS_READ_DATA, pMetadata);
    PRINT(CAM_INTF_PARAM_BOKEH_BLUR_LEVEL, pMetadata);
    PRINT(CAM_INTF_META_RTB_DATA, pMetadata);
    PRINT(CAM_INTF_META_DC_CAPTURE, pMetadata);
    PRINT(CAM_INTF_PARM_BOKEH_MODE, pMetadata);
    PRINT(CAM_INTF_META_USERZOOM, pMetadata);
    ...
    PRINT(CAM_INTF_PARAM_COUNTER, pMetadata);
